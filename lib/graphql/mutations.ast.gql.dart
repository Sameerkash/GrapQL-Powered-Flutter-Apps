...
const SendMessage = _i1.OperationDefinitionNode(
    ...
    variableDefinitions: [
      ...
      _i1.VariableDefinitionNode(
          ...
          directives: []),
      _i1.VariableDefinitionNode(
          variable: _i1.VariableNode(name: _i1.NameNode(value: 'authorId')),
          type: _i1.NamedTypeNode(
              name: _i1.NameNode(value: 'Int'), isNonNull: true),
          defaultValue: _i1.DefaultValueNode(value: null),
          directives: [])
      ...
      _i1.FieldNode(
          ...
          arguments: [
            ...
            _i1.ArgumentNode(
                ...
                value: _i1.VariableNode(name: _i1.NameNode(value: 'authorId')))
          ],
          directives: [],
          selectionSet: _i1.SelectionSetNode(selections: [
            _i1.FieldNode(
...
const PollMessages = _i1.OperationDefinitionNode(
    type: _i1.OperationType.subscription,
    name: _i1.NameNode(value: 'PollMessages'),
    variableDefinitions: [],
    directives: [],
    selectionSet: _i1.SelectionSetNode(selections: [
      _i1.FieldNode(
...
const document = _i1.DocumentNode(definitions: [SendMessage, PollMessages]);
